...
<html lang="es">
    ...
    <body>
        ...
        <form enctype="multipart/form-data" action="upload.php" method="POST" class="formulario_upload" onsubmit="return validarTema()"> <!-- En esta ocasión he puesto enctype debido a que necesitamos seleccionar una foto,
