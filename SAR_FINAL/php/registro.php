...
<body>
    <form action="registro.php" class="formulario_registro" method="post" id="registro" name="registro">
       ...
       <p>email</p>
       <input type="email" id="email" name="email" required pattern="(((^[a-zA-Z0-9]+@)+[a-zA-Z]+\.)+[a-zA-Z]+$)">
       <p>Contraseña</p>
       ...
       <input type="button" id="boton_registrar2" name="submit" value="Volver atras" onclick="location.href='../index.html'">
    </form>
